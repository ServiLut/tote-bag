                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
                      {selectedOrder.items.map((item) => (
                        <div
                          key={item.id}
                          className="flex gap-4 items-center p-2 rounded-xl hover:bg-base/30 transition-colors"
                        >
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-2">
                    <div className="flex flex-col sm:flex-row gap-2">
                      ...
                      <button
                        ...
                        className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-[10px] font-black uppercase tracking-widest flex items-center gap-2 transition-colors active:scale-95 px-4 py-2 hover:bg-blue-500/10 rounded-xl"
                      >
                        <Share2 className="w-3.5 h-3.5" /> Compartir Recibo
                      </button>
                      <button
